...
let allShips =
    ...
    // 3. From the loaded macro file, pull out the reference to the component, and look up the component file in the component index.
    |> Array.choose (fun (entry, macro) ->
