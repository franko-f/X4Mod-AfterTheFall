...
// The resource maps and standard resource lists that territories reference now live
// in tuning.fs alongside the rest of the balance values.
open X4.Tuning.Resources
